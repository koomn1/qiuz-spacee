...
if (!code.includes("import { ScrollSmoother }")) {
  ...
  code = code.replace(
    ...
    '<div id="smooth-wrapper" className="w-full h-full absolute inset-0"><div id="smooth-content" className="w-full"><div className="flex-1 flex flex-col min-w-0 transition-colors duration-300 relative overflow-x-hidden">'
  );
